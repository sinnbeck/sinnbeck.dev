...
>I am aware that there is some flickering when the file is right on top of the text in the middle of the page. Sadly I have yet to find a solution for this. Let me know if you find a solution so I can update the guide. [@sinnbeck](https://twitter.com/rsinnbeck)
